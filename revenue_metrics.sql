...
cte_final_metrics as (
	...
	left join cte_expansion_contraction as cec 
		on cclb.payment_month = cec.payment_month
  		and cclb.language = cec.language
  		and cclb.age = cec.age
  		
	left join cte_ltv_lifetime as cll 
		on cclb.payment_month = cll.payment_month
